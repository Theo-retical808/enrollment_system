...
<body>
    ...
    <header class="top-nav">
        ...
        <div class="user-actions">
            ...
            <img src="https://ui-avatars.com/api/?name={{ urlencode(Auth::guard('professor')->user()->full_name ?? 'Professor') }}&background=2f3b94&color=fff&length=1" alt="User Avatar" class="avatar">
        </div>
    </header>
